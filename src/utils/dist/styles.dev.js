...
var ProjectHeading = _styledComponents["default"].section(_templateObject3());

exports.ProjectHeading = ProjectHeading;

var TopBarContainer = _styledComponents["default"].div(_templateObject4());

exports.TopBarContainer = TopBarContainer;

var BurgerMenu = _styledComponents["default"].div(_templateObject5());
...
var SocialIconWrapper = _styledComponents["default"].div(_templateObject22());

exports.SocialIconWrapper = SocialIconWrapper;

var IconHolder = _styledComponents["default"].div(_templateObject23()); //Slider Open Animation


exports.IconHolder = IconHolder;
var slideropen = (0, _styledComponents.keyframes)(_templateObject24());
var sliderclose = (0, _styledComponents.keyframes)(_templateObject25()); //Sidebar

var sideBarControl = function sideBarControl(showSideBar) {
  return _styledComponents["default"].div(_templateObject26(), showSideBar ? slideropen : sliderclose);
};

exports.sideBarControl = sideBarControl;

var LinkUl = _styledComponents["default"].ul(_templateObject27());

exports.LinkUl = LinkUl;

var LinkItem = _styledComponents["default"].li(_templateObject28());
